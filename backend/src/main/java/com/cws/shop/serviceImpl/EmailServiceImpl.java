...
public class EmailServiceImpl implements EmailService {
	...
	public void sendVerificationEmail(String email, String token) {
		...
		String link = "https://api-shop-be-bfdgh8fgbzhcfmhb.southindia-01.azurewebsites.net/api/verify?token=" + token;
		...
		message.setText("Click on the link to verify your account: https://api-shop-be-bfdgh8fgbzhcfmhb.southindia-01.azurewebsites.net/api/verify?token=" + token);
